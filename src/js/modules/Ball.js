...
var Ball = function(radius, spotNumber) {
    ...
    Phaser.Group.call(this, Project.game, this, 'ball');

	this.sprite = new Phaser.Sprite(Project.game, 0, 0, spriteSheet);
	...
	this.spotHolder = new Phaser.Group(Project.game, this, 'spotHolder'); //creates group and adds it to display list 
	this.spot = new Phaser.Sprite(Project.game, 0, 0, 'spotSpriteSheet');
    ...
    this.shade = new Phaser.Sprite(Project.game, 0, 0, "shade");
