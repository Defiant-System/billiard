...
playState.create = function () {
	...
	function initGameInfo() {
		...
		gameInfo.ballRadius = gameInfo.adjustmentScale * 1050; //1.4 * 1000 * 1.7; //800
	...
	function initDebug() {
		...
		graphics.lineStyle(lineWidth, 0xff8800, 1);
		let point = gameInfo.wallsArray[0];
		graphics.moveTo(point.x * gameInfo.physScale, point.y * gameInfo.physScale);
		for (var n = 1; n < gameInfo.wallsArray.length; n++) {
			//debug drawings
			point = gameInfo.wallsArray[n];
			graphics.lineTo(point.x * gameInfo.physScale, point.y * gameInfo.physScale);
		}
	...
	function initTable() {
		...
		gameInfo.pottedTray = new Phaser.Sprite(Project.game, -14, 268, "pottedTray");
		gameInfo.pottedTray.anchor = new Phaser.Point(0.5, 0.5);
		gameInfo.tableCanvas.add(gameInfo.pottedTray);
		...
		gameInfo.wallsArray.push(
			new Point(
				gameInfo.adjustmentScale * -31500 + gameInfo.ballRadius,
		...
		gameInfo.lineArray.push({
			name: "tDE",
			stopper: true,
			p1: new Vector2D(-30.5 * tableScale, (35.25 + trayWidth) * tableScale),
			p2: new Vector2D(-30.5 * tableScale, 35.25 * tableScale),
		});
		gameInfo.lineArray.push({
			name: "tEF",
		...
		gameInfo.pocketArray.push({
			...
			position: new Vector2D(
				-50.5 * tableScale - gameInfo.pocketRadius / 2,
		...
		gameInfo.pocketArray.push({
			id: 2,
			position: new Vector2D(
				49.75 * tableScale + gameInfo.pocketRadius / 2,
				-25.25 * tableScale - gameInfo.pocketRadius / 4
			),
			dropPosition: new Vector2D(
				49.75 * tableScale + gameInfo.pocketRadius / 2,
		...
		line.p2 = new Vector2D(-(50 - mouth) * tableScale, -25.15 * tableScale);
		...
		line = new Object();
		line.name = "BC";
		line.p1 = new Vector2D(-(50 - mouth) * tableScale, -25.15 * tableScale);
		line.p2 = new Vector2D(-5.25 * tableScale, -25.15 * tableScale);
		gameInfo.lineArray.push(line);
		...
		line = new Object();
		line.name = "CD";
		line.p1 = new Vector2D(-5.25 * tableScale, -25.15 * tableScale);
		...
		line = new Object();
		line.name = "EF";
		line.p1 = new Vector2D(3 * tableScale, -(23.75 + mouth) * tableScale);
		line.p2 = new Vector2D(5.25 * tableScale, -25.15 * tableScale);
		gameInfo.lineArray.push(line);
		...
		line.name = "FG";
		line.p1 = new Vector2D(5.25 * tableScale, -25.15 * tableScale);
		line.p2 = new Vector2D((49.25 - mouth) * tableScale, -25.15 * tableScale);
		gameInfo.lineArray.push(line);
		...
		line = new Object();
		line.name = "GH";
		line.p1 = new Vector2D((49.25 - mouth) * tableScale, -25.15 * tableScale);
		line.p2 = new Vector2D(50.25 * tableScale, -(25.5 + mouth) * tableScale);
		gameInfo.lineArray.push(line);
		...
		line.name = "KL";
		line.p1 = new Vector2D(50.5 * tableScale, (24.5 - mouth) * tableScale);
		line.p2 = new Vector2D((50.5 + mouth) * tableScale, 24.5 * tableScale);
		gameInfo.lineArray.push(line);

		//line MN
		line = new Object();
		line.name = "MN";
		line.p1 = new Vector2D(49.55 * tableScale, (25 + mouth) * tableScale);
		line.p2 = new Vector2D((49.55 - mouth) * tableScale, 25 * tableScale);
		gameInfo.lineArray.push(line);
		...
		line = new Object();
		line.name = "NO";
		line.p1 = new Vector2D((49.55 - mouth) * tableScale, 25 * tableScale);
		line.p2 = new Vector2D(5.25 * tableScale, 25 * tableScale);
		gameInfo.lineArray.push(line);
		...
		line = new Object();
		line.name = "OP";
		line.p1 = new Vector2D(5.25 * tableScale, 25 * tableScale);
		...
		line = new Object();
		line.name = "UV";
		line.p1 = new Vector2D(-(50.75 + mouth) * tableScale, 25 * tableScale);
		line.p2 = new Vector2D(-50.75 * tableScale, (25 - mouth) * tableScale);
		gameInfo.lineArray.push(line);
		...
		line = new Object();
		line.name = "VW";
		line.p1 = new Vector2D(-50.75 * tableScale, (25 - mouth) * tableScale);
		line.p2 = new Vector2D(-50.75 * tableScale, -(24.25 - mouth) * tableScale);
		gameInfo.lineArray.push(line);
		...
		line = new Object();
		line.name = "WX";
		line.p1 = new Vector2D(-50.75 * tableScale, -(24.25 - mouth) * tableScale);
		line.p2 = new Vector2D(-(50.75 + mouth) * tableScale, -24.5 * tableScale);
		gameInfo.lineArray.push(line);
	...
	function initBalls() {
		...
		for (var n = 0; n < gameInfo.numBalls; n++) {
			...
			//ball properties
			switch (true) {
				case n === 0: break; // cue ball
				case n == 8: ball.targetType = "8 BALL"; break;
				case n < 8: ball.targetType = "SOLIDS"; break;
				case n > 8: ball.targetType = "STRIPES"; break;
			}
